...
# from checkout.py 
SHOP_HANDLER_BILLING_SHIPPING = 'custom_checkout.forms.CustomBillingShippingForm'
...
EMAIL_HOST_PASSWORD = 'Bnmjh11z@gma'
EMAIL_PORT = 587
...
SHOP_DEFAULT_SHIPPING_VALUE = 0.00
SHOP_HANDLER_BILLING_SHIPPING = 'cartridge.shop.checkout.default_billship_handler'
# this is actually used in process of checkout after cart 
SHOP_CHECKOUT_FORM_CLASS = 'custom_checkout.forms.CustomBillingShippingForm'
# SHOP_USE_RATINGS = False 
SHOP_CART_EXPIRY_MINUTES = 200
SHOP_ORDER_EMAIL_BCC = 'brdhunga@gmail.com'

# to fix Invalid literal for Decimal: 'False'
